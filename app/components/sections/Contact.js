...
const Contact = () => {
  ...
  return (
    <div ref={sectionRef} className="w-full px-4 pt-25 flex flex-col bg-backgroundlight" style={{ minHeight: "220vh" }}>

      {/* Sticky wrapper — positioning parent for both black box AND yellow card */}
      <div className="sticky top-0 h-screen relative">

        {/* Black box — no longer contains the card, overflow-hidden is safe now */}
        ...
        {/* Yellow card — sibling to black box, not inside it, so no clipping */}
        <section ref={cardRef} className="absolute bottom-0 right-7 w-[70vw] flex flex-col">
          <div className="w-full h-[900px] rounded-t-3xl bg-[#f6f44a] text-black">
